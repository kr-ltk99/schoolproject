...
public class Stopwatch implements ActionListener{
	...
	String rightcommand1 = q.right1[0];
	String rightcommand2 = q.right1[1];
	String rightcommand3 = q.right1[2];
	String rightcommand4 = q.right1[3];
	String rightcommand5 = q.right1[4];
	int elapsedTime = 0;
	int seconds =0;
	int minutes =0;
	int hours =0;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(q.r.equals(q.right1[0])){
			if(e.getSource()==commandButton){
				right = right_field.getText();
				if(right.equals(rightcommand1))
					new rightclean();
					
			}
		}
		
		else if(q.r.equals(q.right1[1])){
			if(e.getSource()==commandButton){
				right = right_field.getText();
				if(right.equals(rightcommand2))
					new rightclean();
			}
		}
		
		else if(q.r.equals(q.right1[2])){
			if(e.getSource()==commandButton){
				right = right_field.getText();
				if(right.equals(rightcommand3))
					new rightclean();
			}
		}

		else if(q.r.equals(q.right1[3])){
			if(e.getSource()==commandButton){
				right = right_field.getText();
				if(right.equals(rightcommand4))
					new rightclean();
			}
		}

		else if(q.r.equals(q.right1[4])){
			if(e.getSource()==commandButton){
				right = right_field.getText();
				if(right.equals(rightcommand5))
					new rightclean();
			}
		}
